...
export const register = async (req: Request, res: Response) => {
    ...
    const newUser = {id: generateId(), name, email, password: hashedPassword, createdAt: new Date(), updatedAt: new Date()};
    users.push(newUser); // coloca o novo usuário na array de usuários
